...
public class BattleShipMAIN {
      ...
      if (board[row][col] == 'O' || board[row][col] == 'X') {
        ...
        System.out.println("You already hit here!");
          ...
          if (AREA > 10) {
            System.out.println("DEBUG 4");
          fireCount++;
            //System.out.println("DEBUG: " + shipCounter);
          for (int i = 0; i < shipCounter; i++) {
            System.out.println("DEBUG 5");
            System.out.println("hehe: " + shipColArray[i] + " " + shipRowArray[i]);
          ...
          if (board[row][col] == 'O' || board[row][col] == 'X') {
            ...
            if (board[row][col] == 'O' || board[row][col] == 'X') {
              ...
              hit = false;
                ...
                for (int i = 0; i < shipSize; i++) { // 2, 3, or 4
                  if ((col == shipCol && row == shipRow + i) || (row == shipRow && col == shipCol + i)) {
                  hit = true;
                  System.out.println("Hit!");
                  hitCounter++;
  ...
  private static boolean isGameOver() {
    if (AREA > 10) {
			//System.out.println("DEBUG: " + ShipHitCounter);
			//System.out.println("DEBUG: " + shipSizeArray[0] + shipSizeArray[1] + shipSizeArray[2] + shipSizeArray[3]);
